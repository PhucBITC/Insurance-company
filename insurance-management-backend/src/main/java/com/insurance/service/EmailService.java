...
public class EmailService {
    ...
    public void sendPasswordResetEmail(String recipientEmail, String otp, String resetLink) {
        ...
        try {
            ...
            String htmlContent = "<div style=\"font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 20px; max-width: 600px; border: 1px solid #e0e0e0; border-radius: 8px;\">" +
                    ...
                    "<p>Chào bạn,</p>" +
                    "<p>Hệ thống nhận được yêu cầu đặt lại mật khẩu cho tài khoản liên kết với email này. Vui lòng nhập mã OTP dưới đây tại giao diện đặt lại mật khẩu, hoặc click vào nút bên dưới để tiến hành đổi mật khẩu mới (có hiệu lực trong vòng 15 phút):</p>" +
                    ...
                    "<a href=\"" + resetLink + "\" style=\"background-color: #6366f1; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block;\">Đặt lại mật khẩu trực tiếp</a>" +
                    "</div>" +
